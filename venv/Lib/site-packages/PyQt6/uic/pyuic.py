...
from .exceptions import NoSuchClassError, NoSuchWidgetError, UIFileException
...
def main():
    ...
    parser = argparse.ArgumentParser(prog='pyuic6',
...
- your version of pyuic6 ({0})
- the .ui file that caused this error
- the debug output of pyuic6 (use the --debug flag when calling pyuic6)""".format(PYQT_VERSION_STR), file=sys.stderr)
