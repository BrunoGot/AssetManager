...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def __init__(self, data: PyQt6.sip.Buffer, width: int, height: int, format: 'QImage.Format', cleanupFunction: typing.Optional[typing.Callable[..., None]] = ..., cleanupInfo: typing.Optional[typing.Any] = ...) -> None: ...
    @typing.overload
    def __init__(self, data: PyQt6.sip.Buffer, width: int, height: int, bytesPerLine: int, format: 'QImage.Format', cleanupFunction: typing.Optional[typing.Callable[..., None]] = ..., cleanupInfo: typing.Optional[typing.Any] = ...) -> None: ...
    @typing.overload
    def __init__(self, xpm: typing.List[str]) -> None: ...
    @typing.overload
    def __init__(self, fileName: str, format: typing.Optional[str] = ...) -> None: ...
